...
map<int, vector<pair<int, Eigen::Matrix<double, 7, 1>>>> FeatureTracker::trackImage(double _cur_time, const cv::Mat &_img, const cv::Mat &_img1)
{
    ...
    */
    ...
    if (prev_pts.size() > 0)
    {
        ...
        {
            ROS_ERROR("CUDA optical flow not supported in this build");
            // CUDA code removed for CPU build
        }
    ...
    if (1)
    {
        ...
        {
             ROS_ERROR("CUDA features not supported in this build");
             n_pts.clear();
        }
    ...
    if(!_img1.empty() && stereo_cam)
    {
        ...
        if(!cur_pts.empty())
        {
            ...
            {
                ROS_ERROR("CUDA stereo flow not supported");
            }
            ids_right = ids;
